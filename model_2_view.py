...
def load_data(args):
    ...
    # path = args.data_dir
    # rate = args.rate
    source_data = np.load('H:\MIXCNN\cwru_data.npy')
    source_label = np.load('H:\MIXCNN\cwru_label.npy')
    ...
    Validate = Dataset(x_validate, y_validate)
...
def run_step(args):  # epoch=10
    ...
    #step_len = [420]
    # step_len = [210]
    sample1, sample1_validate, sample1_test = load_data(args)
